...
<table class = "table table-sm table-dark">
    ...
    <c:forEach var="customer" items="${customers}">
        <c:if test="${customers.id == edited_id}">
            <tr>
                <form action="/customers" method="post">
                    <td>
                        <input type="number" class="form-control form-control-sm" name="editedId" value="${customers.id}" readonly>
                    </td>
                    <td>
                        <input type="text" class="form-control form-control-sm" name="editedFirstName" value="${customers.firstName}">
                    </td>
                    <td>
                        <input type="text" class="form-control form-control-sm" name="editedLastName" value="${customers.lastName}">
                    </td>
                    <td>
                        <input type="date" class="form-control form-control-sm" name="editedBirthday" value="${customers.birthday}">
                    </td>
                    <td>
